...
if (!isPremium) {
  ...
  messages = [
    {
      role: "system",
      content: "You are a friendly Nigerian historian. Use simple English and small pidgin. Keep it short and clear."
    },
    {
      role: "user",
      content: `
...
`
  ...
  messages = [
    {
      role: "system",
      content: "You are a deeply knowledgeable Nigerian historian and storyteller. Be rich, detailed, culturally grounded, and confident."
    },
    {
      role: "user",
      content: `
...
const text = completion.choices[0].message.content || "";
  ...
  text.split("Ancestral Occupation:")[1]?.split("Migration Pattern:")[0]?.trim() || "";

const migration =
  text.split("Migration Pattern:")[1]?.split("Royal/Heritage Insight:")[0]?.trim() || "";

const royal =
  text.split("Royal/Heritage Insight:")[1]?.split("Cultural Insight:")[0]?.trim() || "";
